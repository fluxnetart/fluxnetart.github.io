...
<a href = "https://fluxnet.org/">FLUXNET</a> is a global network of micrometeorological tower sites that measure the exchanges of carbon dioxide, water vapor, and energy between the biosphere and atmosphere. Our artist in residence program aims to illuminate flux science – to contemplate the biosphere’s ‘breath’, both to capture the general public’s imagination and to strengthen communication between academics and society toward more actionable science. 

fluxArt is supported by the National Science Foundation’s Accelerating Research through International Network-to-Network Collaborations (NSF AccelNet) program, Award 2113978 and partnered with the Patricia Valian Reser Center for Creative Arts ((<a href = "https://prax.oregonstate.edu/">PRAx</a>). 
